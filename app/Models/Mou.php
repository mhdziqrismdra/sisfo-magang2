...
class Mou extends Model
{
    ...
    protected $fillable = ['tanggal_kerja_sama', 'nama_lembaga_mitra', 'negara_id', 'provinsi_id', 'kota_kabupaten_id', 'kecamata_id', 'kelurahan_id', 'alamat', 'durasi_kerja_sama', 'status'];
